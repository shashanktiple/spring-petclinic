# Spring PetClinic Sample Application [![Java CI with Maven](https://github.com/shashanktiple/spring-petclinic/actions/workflows/maven.yml/badge.svg)](https://github.com/shashanktiple/spring-petclinic/actions/workflows/maven.yml)
